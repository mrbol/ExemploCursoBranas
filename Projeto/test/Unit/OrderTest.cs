...
namespace Unit
{
    ...
    public class OrderTest
    {
        ...
        public void CriarPedido_CpfInvalido() {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => new Order("111.111.111-11"));
        ...
        public void CriarPedido_ComQuantidadeNegativa()
        {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => order.AddItem(new Item(1, "Guitarra", 1000), -1));
