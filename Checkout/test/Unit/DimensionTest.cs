...
namespace Unit
{
    public class DimensionTest
    {
        ...
        public void Dimensoes_largura_Negativas()
        {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => new Dimension(-1,0,0,0));
        ...
        public void Dimensoes_Altura_Negativas()
        {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => new Dimension(0, -1, 0, 0));
        ...
        public void Dimensoes_Profundidade_Negativas()
        {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => new Dimension(0, 0, -1, 0));
        ...
        public void Dimensoes_peso_Negativas()
        {
            ...
            //Act
            var myException = Assert.Throws<AppException>(() => new Dimension(0, 0, 0, -1));
